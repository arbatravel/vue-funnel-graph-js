(function (global, factory) {
    ...
    var script = {
        ...
        computed: {
            valuesFormatted: function valuesFormatted() {
                if (this.graph.is2d()) {
                    return this.graph.getValues2d().map(function (value) { return Number.isInteger(value)? number.formatNumber(value): value; });
                }
                return this.values.map(function (value) { return Number.isInteger(value)? number.formatNumber(value): value; });
            },
        ...
        filters: {
            format: function (value) {
                return Number.isInteger(value)? number.formatNumber(value): value
            }
        }
    };
    ...
    /* template */
    var __vue_render__ = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"funnel svg-funnel-js",class:{'svg-funnel-js--vertical': _vm.direction === 'vertical'}},[_c('div',{staticClass:"svg-funnel-js__container"},[_c('svg',{attrs:{"width":_vm.width,"height":_vm.height}},[_c('defs',_vm._l((_vm.gradientSet),function(colors,index){return _c('linearGradient',{key:'1' + index,attrs:{"id":("funnelGradient-" + ((index+1))),"gradientTransform":_vm.gradientAngle}},_vm._l((colors.values),function(color,index){return _c('stop',{key:'2' + index,attrs:{"stop-color":color,"offset":_vm.offsetColor(index, colors.values.length)}})}),1)}),1),_vm._v(" "),_vm._l((_vm.paths),function(path,index){return _c('path',{key:'3' + index,attrs:{"fill":_vm.colorSet[index].fill,"stroke":_vm.colorSet[index].fill,"d":path}})})],2)]),_vm._v(" "),_c('transition-group',{staticClass:"svg-funnel-js__labels",attrs:{"name":"appear","tag":"div"},on:{"enter":_vm.enterTransition,"leave":_vm.leaveTransition}},_vm._l((_vm.valuesFormatted),function(value,index){return _c('div',{key:_vm.getRandom() + _vm.labels[index].toLowerCase().split(' ').join('-'),staticClass:"svg-funnel-js__label",class:("label-" + ((index+1)))},[(value.includes('RM'))?_c('div',{staticClass:"label__value",staticStyle:{"font-size":"12px","font-weight":"600","line-height":"16px","letter-spacing":"#{(-40/1000)}em","color":"#2B2525","margin-left":"8px"}},[_vm._v(_vm._s(value))]):_c('div',{staticClass:"label__value",staticStyle:{"font-size":"18px","font-weight":"700","line-height":"24px","letter-spacing":"#{(-30/1000)}em","color":"#2B2525","margin":"0px"}},[_vm._v(_vm._s(value))]),_vm._v(" "),(_vm.labels && _vm.labels[index].toString().includes('⬇'))?_c('div',{staticClass:"label__title",staticStyle:{"font-size":"12px","font-weight":"400","line-height":"16px","letter-spacing":"#{(-40/1000)}em","color":"#CD3300","margin-top":"-4px"}},[_c('i',{staticClass:"mdi mdi-arrow-down",staticStyle:{"position":"relative","top":"1px","font-size":"15px"}}),_vm._v(" "),_c('span',[_vm._v(" "+_vm._s(_vm.labels[index].replace('⬇',''))+" ")])]):(_vm.labels && _vm.labels[index].toString().includes('⬆'))?_c('div',{staticClass:"label__title",staticStyle:{"font-size":"12px","font-weight":"400","line-height":"16px","letter-spacing":"#{(-40/1000)}em","color":"#009966","margin-top":"-4px"}},[_c('i',{staticClass:"mdi mdi-arrow-up",staticStyle:{"position":"relative","top":"1px","font-size":"15px"}}),_vm._v(" "),_c('span',[_vm._v(" "+_vm._s(_vm.labels[index].replace('⬆',''))+" ")])]):(_vm.labels)?_c('div',{staticClass:"label__title",staticStyle:{"font-size":"13px","font-weight":"600","line-height":"24px","letter-spacing":"#{(-40/1000)}em","color":"#2B2525"}},[_vm._v(_vm._s(_vm.labels[index]))]):_vm._e(),_vm._v(" "),(_vm.displayPercentage && _vm.percentages()[index] !== 100)?_c('div',{staticClass:"label__percentage",staticStyle:{"font-size":"12px","font-weight":"400","line-height":"16px","letter-spacing":"#{(-40/1000)}em","color":"#2B2525","margin-bottom":"8px"}},[(index != 0)?_c('span',[_vm._v(" "+_vm._s(_vm.percentages()[index])+"% from "+_vm._s(_vm.labels[index - 1])+" ")]):_c('span',[_vm._v(" "+_vm._s(_vm.percentages()[index])+"% ")])]):_vm._e(),_vm._v(" "),(_vm.is2d())?_c('div',{staticClass:"label__segment-percentages"},[_c('ul',{staticClass:"segment-percentage__list"},_vm._l((_vm.subLabels),function(subLabel,j){return _c('li',{key:'5' + j},[_vm._v("\n                        "+_vm._s(subLabel)+":\n                        "),(_vm.subLabelValue === 'percent')?_c('span',{staticClass:"percentage__list-label"},[_vm._v(_vm._s(_vm.twoDimPercentages()[index][j])+"%")]):_c('span',{staticClass:"percentage__list-label"},[_vm._v(_vm._s(_vm._f("format")(_vm.values[index][j])))])])}),0)]):_vm._e()])}),0)],1)};
    var __vue_staticRenderFns__ = [];

      /* style */
      var __vue_inject_styles__ = function (inject) {
        if (!inject) { return }
        inject("data-v-b9f62c9c_0", { source: ".h6[data-v-b9f62c9c],h6[data-v-b9f62c9c]{font-size:18px!important;font-style:normal;font-weight:700!important;line-height:24px!important;letter-spacing:-.03em!important;color:#2b2525}.s2[data-v-b9f62c9c]{font-size:13px!important;font-style:normal;font-weight:600!important;line-height:24px!important;letter-spacing:-.04em!important;color:#2b2525}.appear-enter-active[data-v-b9f62c9c],.appear-leave-active[data-v-b9f62c9c]{transition:all .7s ease-in-out}.appear-enter-to[data-v-b9f62c9c],.appear-leave[data-v-b9f62c9c]{max-width:100%;max-height:100%;opacity:1}.appear-enter[data-v-b9f62c9c],.appear-leave-to[data-v-b9f62c9c]{max-width:0;max-height:0;opacity:0}.fade-enter-active[data-v-b9f62c9c],.fade-leave-active[data-v-b9f62c9c]{transition:all .3s ease}.fade-enter-to[data-v-b9f62c9c],.fade-leave[data-v-b9f62c9c]{opacity:1}.fade-enter[data-v-b9f62c9c],.fade-leave-to[data-v-b9f62c9c]{opacity:0}", map: undefined, media: undefined });

      };
      /* scoped */
      var __vue_scope_id__ = "data-v-b9f62c9c";
      /* module identifier */
